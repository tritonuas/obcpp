...
int main() {
    ...
    PathingPlot plotter(flightBounds, airdropBounds, waypoints);
    ...
    plotter.output("test_plot.jpg", PathOutputType::STATIC);
    plotter.output("test_plot.gif", PathOutputType::ANIMATED);
}