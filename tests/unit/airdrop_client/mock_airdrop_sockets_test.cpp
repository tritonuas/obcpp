...
TEST(MockAirdropSocketTest, TestSendMessageObcToPayload) {
    ...
    parseID(mode_p->id, &bottle, &state);
    ...
    send_ad_packet(obc_socket, makeHeartbeatPacket(UDP2_E, OBC_NULL, 0.5, 7.5, 9, 95));
