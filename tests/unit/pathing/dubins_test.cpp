...
TEST(DubinsTest, CircleArc)
{
    ...
    Vector result1 = dubins1.circleArc(origin_x, 1,
    ...
    // turning 2.97 rad
    Vector result2 = dubins1.circleArc(origin_x, -1,
    ...
    Vector result4 = dubins1.circleArc(origin_y, 1,
...
TEST(DubinsTest, GenPointsStraight)
{
    ...
    std::vector<Vector> result1 = dubins1.generatePointsStraight(origin_x, arbitrary_position1, path);
    std::vector<Vector> expected_result1 = {
        Vector{6.123233995736766e-16, 0.0, 0},
...
TEST(DubinsTest, GenPoints)
{
    ...
    std::vector<Vector> result1 = dubins1.generatePoints(origin_x, arbitrary_position1, lsl.dubins_path, lsl.has_straight);
    std::vector<Vector> result2 = dubins1.generatePoints(origin_x, arbitrary_position1, lrl.dubins_path, lrl.has_straight);
    ...
    std::vector<Vector> expected_result2 = {
        Vector{6.123233995736766e-16, 0.0, 0},
        Vector{0.9933466539753065, 0.09966711079379209, 0},
        Vector{1.9470917115432524, 0.3946950299855745, 0},
        Vector{2.823212366975177, 0.8733219254516085, 0},
